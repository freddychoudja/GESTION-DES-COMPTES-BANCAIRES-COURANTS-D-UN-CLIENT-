...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-4gjjpiykdh38wl%(s9)$c&jpk@$0#_io#s^p)tqfza*%#escsx')
...
# PostgreSQL configuration (use environment variables or SQLite as fallback)
DATABASES = {
    'default': {
